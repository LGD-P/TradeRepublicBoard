...
const dict = {
  en: {
    ...
    set_online_sub: "Optional. Fetch current prices by ISIN from a proxy you run — only the ISIN leaves your browser, never your holdings. When set, prices refresh once on import. Leave empty to stay fully offline.",
  ...
  fr: {
    ...
    set_online_sub: "Optionnel. Récupère les cours par ISIN via un proxy que tu héberges — seul l'ISIN quitte ton navigateur, jamais tes positions. Une fois renseigné, les cours s'actualisent à l'import. Laisse vide pour rester 100 % hors-ligne.",
