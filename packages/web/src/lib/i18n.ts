...
const dict = {
  en: {
    ...
    refresh_hint: "Auto-refresh: turn on/off in Settings",
    theme: "Theme", import: "Import",
    import_hint: "Import a Trade Republic CSV export for your real data",
    privacy_hint: "Hide sensitive figures — shortcut: H",
    ...
    set_online_sub: "Fetch current prices by ISIN from a proxy — only the ISIN leaves your browser, never your holdings.",
    set_refresh_now: "Refresh prices now",
    set_auto: "Auto-refresh", set_auto_sub: "Refreshes on import and every minute while the tab is open. Needs the proxy running.",
  ...
  fr: {
    ...
    refresh_hint: "Actualisation auto : activable dans les Réglages",
    theme: "Thème", import: "Importer",
    import_hint: "Importe un export CSV Trade Republic pour tes vraies données",
    privacy_hint: "Masquer les montants sensibles — raccourci : H",
    ...
    set_online_sub: "Récupère les cours par ISIN via un proxy — seul l'ISIN quitte ton navigateur, jamais tes positions.",
    set_refresh_now: "Actualiser les cours",
    set_auto: "Actualisation auto", set_auto_sub: "S'actualise à l'import et chaque minute tant que l'onglet est ouvert. Nécessite le proxy en marche.",
